...
public class Server implements Runnable {
    ...
    public void run() {
     ...
     while(running){
       ...
       if(text.equals("raw")){
           if(raw)System.out.println("Raw mod off.");
           else System.out.println("Raw mod on.");
         raw =!raw;  
       }else if(text.equals("clients")){
           System.out.println("Упыри: ");
            System.out.println("======");
    ...
    private void printHelp(){
        ...
        System.out.println("/clients-shall all connected clients.");
        System.out.println("/kick [users ID of username] - kicks a user.");
       ...
       receive = new Thread("Receive"){
         public void run(){
           while(running){
               ...
               process(packet); 
              // clients.add(new ServerClient("жекка",packet.getAddress(),packet.getPort(),50));
